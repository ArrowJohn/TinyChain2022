...
var messageType = MessageType{"LatestBlockChain", "CurrentWinner", "NewTransaction", "NewProposedBlock", "NewJoinNode"}
...
func main() {
	...
	tra = Transaction{t.String(), "genesisTransaction", "0", calculateHash(t.String() + "genesisTransaction" + "0" + "Hao" + string(20)), Addresses[0], 500}

	genesisBlock = Block{0, t.String(), tra, "Genesis transaction: 06/10/2020", calculateBlockHash(genesisBlock), "", "8891"}
...
func generateBlock(oldBlock Block, thisTran Transaction, address string, nextValidator string) (Block, error) {
	var newBlock Block
